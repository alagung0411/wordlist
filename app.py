...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.bm9zl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
client = MongoClient(cxn_str)
db = client.dbsparta_plus_week2

@app.route('/')
def main():
    database_data = db.words.find({}, {'_id': False})
    words = []
    for word in database_data:
...
def save_ex():
    ...
    return jsonify({
        'result': 'success',
        'msg': f'Your example | {example} | for word | {word} | was saved!'
    })
